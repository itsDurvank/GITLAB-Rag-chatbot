...
# Input files
file1 = Path("Part1/Data_Acquisition/raw_data/Direction/direction_cleaned.txt")  # Clean but might miss extras
file2 = Path("Part1/Data_Acquisition/raw_data/Direction/raw_direction.txt")      # Raw dump with possibly missed parts
